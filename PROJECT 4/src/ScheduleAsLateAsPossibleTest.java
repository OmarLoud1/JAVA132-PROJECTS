...
public class ScheduleAsLateAsPossibleTest extends ScheduleAsLateAsPossible {
    Job job1 = new Job(1,2,6,2,2);
    Job job2 = new Job(2,4,9,3,2);
    Job job3 = new Job(3,5,13,2,2);
    Job job4 = new Job(4,1,4,2,2);
    Job job5 = new Job(5,1,10,1,2);
    ...
    public void scheduleJob() {
       ...
       // assertEquals(schedule.getFirst().getStartTime(), 2);
        ...
        //compund job test
        Job subjob1 = new Job(1,10,2,2,0);
        ...
        Job subjob5 = new Job(1,10,2,2,0);
